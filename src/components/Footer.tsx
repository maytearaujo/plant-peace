        ...
        <div className='relative flex'>
          ...
          <div className=' ml-auto mt-[20px] md:mt-[174px] flex'>
            <ul className="mr-[8px] md:mr-[52px] space-y-[5px] md:space-y-[16px]">
              ...
              <li className='font-raleway text-[10px] md:text-[16px]'><a href="/about-us">About Us</a></li>
              <li className='font-raleway text-[10px] md:text-[16px]'><a href="/products">Products</a></li>
              <li className='font-raleway text-[10px] md:text-[16px]'><a href="/blogs">Blogs</a></li>
            </ul>
