...
const Header = () => {
  ...
  return (
    <div className="fixed z-50 px-12 bg-wisper flex justify-between py-8 md:justify-around items-center w-[100vw] h-20 font-raleway font-normal text-lg text-primaryLunarGreen">
      ...
      <div className="flex flex-row items-center w-[55%] hidden md:flex justify-between ml-14">
        <section className="w-[60%] h-20 lg:flex lg:justify-evenly">
          <ul className="flex flex-row justify-around items-center w-[100%] h-full">
            <li className="hover:text-primaryAvacado px-4"><a href="/">Home</a></li>
            <li className="hover:text-primaryAvacado px-4"><a href="#">Register</a></li>
            <li className="hover:text-primaryAvacado px-4"><a href="#">Poducts</a></li>
            <li className="hover:text-primaryAvacado px-4"><a href="/about">About us</a></li>
            <li className="hidden hover:text-primaryAvacado px-4"><a href="#">Blog</a></li>
          </ul>
