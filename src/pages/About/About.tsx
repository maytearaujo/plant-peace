...
const About = () => {
    ...
    const aboutData = [
        { background:"bg-wisper", bgCard:"rounded-2xl border-2 border-black bg-cardAbout", image: `${import.meta.env.BASE_URL}assets/about/mayte.jpg`, spotify: "https://open.spotify.com/embed/playlist/6brnn7kQ2A4Im1ZsjQ6sEU?utm_source=generator", title: 'Maytê Araújo', subtitle: 'Praia Grande-SP', hobbies: "Pilates, ler, séries.", github: "https://github.com/maytearaujo", linkedin: "https://www.linkedin.com/in/maytearaujo/", },
