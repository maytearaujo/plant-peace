...
const About = () => {
    ...
    const aboutData = [
        ...
        { background:"bg-wisper", bgCard:"rounded-2xl border-2 border-black bg-cardAbout", image: "/src/assets/about/cat.jpg", spotify: "https://open.spotify.com/embed/playlist/5EBPyhKvxk8EGpF0hLAlAv?utm_source=generator", title: 'Rebeca Santos', subtitle: 'Sorocaba', hobbies: "Cozinhar, desenhar, pintar.", github: "https://github.com/rebcs", linkedin: "https://www.linkedin.com/in/rebeca-santos-1b9766257/", },
        { background:"bg-bgAbout", bgCard:"rounded-2xl border-2 border-black bg-wisper", image: "/src/assets/about/cat.jpg", spotify: "https://open.spotify.com/playlist/3PwutLiElOYWoHi6QqB7YL?si=7TIBc3s6QCagqbfPfMa1hg&pi=0nvSY9iOQ9eAJ", title: 'Maria Eduarda', subtitle: 'Jacupiranga-SP', hobbies: "Dança, crochê, séries", github: "https://github.com/maducsilva", linkedin: "https://www.linkedin.com/in/maria-eduarda-cardoso-da-silva-a81807288/", },
        { background:"bg-wisper", bgCard:"rounded-2xl border-2 border-black bg-cardAbout", image: "/src/assets/about/cat.jpg", spotify: "https://open.spotify.com/embed/playlist/6EdmCzfkypIrnOVuEq9Kd6?utm_source=generator&theme=0", title: 'Nome do Bolsista', subtitle: 'cidade', hobbies: "", github: "https://github.com/", linkedin: "https://br.linkedin.com/", },
    ];
